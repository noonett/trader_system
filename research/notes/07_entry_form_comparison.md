...
**Pratap et al. (2020) *npj Digital Medicine*（已在 06 笔记引用，S 级）**
- mHealth 头 100 日 70% 用户离开
- 抛弃曲线向下递减（"早期高、稳定下降"）
...
- Cockburn et al. 2014 "CommandMaps" *CHI 2014*（S 级）：扁平 spatial 命令布局对 expert 显著优于层级菜单；novice 无 penalty
...
**Cockburn et al. 2014 *CHI 2014* "CommandMaps"**【S 级】
...
- Cockburn et al. (2014) *CHI* — CommandMaps spatial command

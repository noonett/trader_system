...
> ⚠️ **状态标注（v5 新增）**：本笔记反映**调研当时的中间结论**。最终系统约束以 [`foundation_2026.md`](../foundation_2026.md) **最新版本（v5+）** 为准。本笔记内容不再修改，作为历史可追溯档案保留。如本笔记的某些建议与 foundation 最新版本冲突，以 foundation 为准。
>
> 调研日期：2026-05-05

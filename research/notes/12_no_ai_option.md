...
### 6.2 Andersson / Carlbring 系列：guided iCBT vs face-to-face CBT（v2 修正）

> **v2 引用更正**：v1 此节标题与第一句把"guided iCBT 与 face-to-face CBT 不可区分"归到 Karyotaki 2017。实际 Karyotaki 2017 *JAMA Psychiatry* IPD meta（n≈3,876/13 RCTs）研究的是 **self-guided/unguided iCBT**，**不是** "guided vs face-to-face"。"guided iCBT 与 face-to-face CBT 在多种 outcome 上不可区分" 的正确出处是 Andersson & Carlbring 系列。

【S 级】**Andersson & Cuijpers 2009 *Cognitive Behaviour Therapy* 元分析 + Andersson 2014 *World Psychiatry* + Carlbring, Andersson, Cuijpers, Riper, Hedman-Lagerlöf 2018 *Cognitive Behaviour Therapy*** iCBT vs face-to-face CBT

- guided iCBT 与 face-to-face CBT 在多种 outcome 上**统计上不可区分**（pooled g 接近 0，CI 跨零）；
- 这一发现在后续 IAPT real-world 数据中被复制（Palacios et al. 2022, BJP, n=21,215）。

【S 级】**Karyotaki et al. 2017 *JAMA Psychiatry* IPD meta-analysis**（修正后保留为相邻证据）

- 主题：**self-guided（unguided）iCBT** 在抑郁症状改善上的疗效（n≈3,876, 13 RCTs）
- 结论：unguided iCBT 比对照组显著有效但效应量小于 guided 版本；适合作为"低强度阶梯护理"的入门层
- **与 6.2 主题（guided vs face-to-face）相邻但不直接对应**——v1 把两个 claim 混在一个引用里。
...
6. **Karyotaki, E. et al. (2017).** "Efficacy of Self-guided Internet-Based Cognitive Behavioral Therapy in the Treatment of Depressive Symptoms: A Meta-analysis of Individual Participant Data." *JAMA Psychiatry*. n≈3,876, 13 RCTs（**self-guided/unguided iCBT** 主题）。

6a. **Cuijpers, P. et al. (2021).** "A network meta-analysis of psychological treatments for adult depression." *JAMA Psychiatry*. n=39 RCTs, 9,751 participants（v1 误把这条数字归在 Karyotaki 2017，**v2 修正**）。
6b. **Andersson, G. (2014).** "The promise and pitfalls of the internet for cognitive behavioral therapy." *World Psychiatry*；**Carlbring, P., Andersson, G., Cuijpers, P., Riper, H., Hedman-Lagerlöf, E. (2018).** "Internet-based vs. face-to-face cognitive behavior therapy for psychiatric and somatic disorders: an updated systematic review and meta-analysis." *Cognitive Behaviour Therapy*（**guided iCBT vs face-to-face 元分析**——这才是 v1 §6.2 应引的来源，**v2 修正**）。
...
1. Cipriano, M.C., Gruca, T.S., Jiao, J. (2020). Can investing diaries be hazardous to your financial health? *J Prediction Markets*.
2. McKenna et al. (2018/2024). Self-monitoring using digital vs paper DBT diary card. UW research.
3. Honary et al. (2023). Time investment as dropout predictor. *JMIR mHealth*.
4. Linardon, J. (2024). Engagement-effectiveness paradox in digital mental health. *BMC Digital Health*.
5. Mohr, D. et al. (2023). Engagement in digital mental health: dose-response. *Curr Treat Options Psychiatry*.
6. Sohal, M. et al. (2022). Efficacy of journaling: systematic review and meta-analysis. *Family Medicine and Community Health*.
7. Avila-Gutierrez et al. (2023). Bullet Journal for mental health self-care. *InfoDesign*.
8. Bibault, J.-E. et al. (2022). Conversational agent for thought recording: feasibility study. PMC9343632.
9. Sheppard Pratt (2024). ChatOCD: Pitfalls of using AI when you have OCD. Hospital clinical advisory.
10. Levin, M.E. et al. (2026). Transdiagnostic model for AI chatbots perpetuating OCD/anxiety. *npj Digital Medicine*.
11. Irish Journal of Psychological Medicine (2025). Generative AI and reassurance-seeking in OCD.
12. Vox 2024 reporting on ChatGPT-OCD interactions.
13. TreatMyOCD blog (2025). Clinical observations on AI reassurance loops.
14. NEDA Tessa case (2023). NPR / news-medical reporting + Museum of Failure documentation.
15. Padilla Senate Report (2024). AI Chatbot Safety: Replika.
16. Laestadius, L. et al. (2022). Too human and not human enough: Replika emotional dependence harms. *NMS*.
17. Nature Mental Health (2026). Technological folie à deux.
18. Boylan, J. et al. (2023). Self-tracking and perfectionism dimensions. PMC10699291.
19. Iivanainen, R. (2024). Personal quantification bias. Medium synthesis.
20. Modern Stoicism / Macaro, A. (2024). Premeditatio malorum: friend or foe?
21. Atticus Poet, Stoic Handbook (2024-2025). Modern tier-based premeditatio.
22. Frontiers in Psychology (2022). 6-Minutes Journal RCT 4 weeks.
23. Schoo, F. et al. (2022). Gratitude app COVID-19 RCT.
24. Springer J Happiness Studies (2025). Gratitude training RCT, journaling vs menu.
25. EEF (2025). AI tutor meta-analysis 83 studies.
26. Stanford SCALE (2024-2025). AI feedback comparison.
27. WHO Surgical Safety Checklist (2010). Implementation guidance.
28. Cuijpers, P. et al. (2021). IPD meta-analysis on iCBT subgroups. *JAMA Psychiatry*.
29. Palacios, J. et al. (2022). IAPT step-care comparison, BJP, n=21,215.
30. CAT-SH IAPT pilot (Marsh et al. 2017).
31. LIGHTMind RCT (2022). MBCT vs CBT bibliotherapy. JAMA Psychiatry.
32. Chinese PLA expressive writing study (2024). Repetitive negative thinking in new recruits.
33. Mueller, P.A. & Oppenheimer, D.M. (2014). The Pen Is Mightier Than the Keyboard. *Psychological Science*.
34. Umejima, K. et al. (2021). Paper Notebooks vs Mobile Devices: Brain Activation Differences during Memory Retrieval. *Frontiers in Behavioral Neuroscience*.
35. Bullet Journal Flexible Mindful Self-Tracking (UCL Discovery 2017).
36. Voluntary Self-Exclusion long-term effects (2023). *J Gambling Studies*.

**W 级（行业 / 营销 / 二手）**：

1. Mark Douglas. *Trading in the Zone*; *The Disciplined Trader* (1990 / 2000).
2. Daily Stoic / Ryan Holiday (2016+). 商业产品 + 用户社区.
3. Cohorty 2024, GoalFlow 2024 (accountability success rate stats).
4. Various 5-Minute Journal / Bullet Journal 用户社区报告.
5. Federico Ferrarese 2026 clinical practice blog "When AI Becomes a Compulsion".

**U 级（基于已知文献的逻辑推演 / 本笔记原创校准）**：

1. 本调研第七节"用户分群建议"中的 A/B/C/D 阈值与切换条件——基于以上证据 + v5 §三.11 框架的推演，未经 RCT 验证；
2. "3 月观察期"作为 No-AI 默认时长——借用 DSM-5 problem gambling 评估窗口 + 习惯形成曲线，未经验证；
3. "monthly 1 hour peer review"作为最小人工接触底线——基于 BMC Psychiatry 2022 d=0.65（≤10 min/wk）的等效推算；
4. 第七节"双轨系统"建议——基于"风险不对称 + 用户异质性"的逻辑推演。

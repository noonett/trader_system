...
| [14_semi_auto_trading_ai_landscape.md](../research/notes/14_semi_auto_trading_ai_landscape.md)     | 半自动交易 AI 助手产品形态与设计模式    | ~400  | —     |
| [15_market_learnings_to_sigma_optimization.md](../research/notes/15_market_learnings_to_sigma_optimization.md) | 市场学习 → σ 设计优化方案（5 项 OPT） | ~350  | —     |
